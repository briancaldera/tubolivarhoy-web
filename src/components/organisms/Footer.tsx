    ...
    <footer className='bg-white border-t border-gray-100 py-12'>
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          <div className='space-y-4'>
            ...
            <p className='text-gray-600'>
              La forma más sencilla de convertir divisas y realizar un
              seguimiento de los tipos de cambio.
            </p>
            <div className='flex space-x-4'>
              <Link
                href='https://play.google.com/store/apps/dev?id=5515021505297833447'
              ...
              <Link
                href='https://www.instagram.com/brianc.dev/'
                className='text-gray-400 hover:text-primary-end transition-colors'
                target='_blank'
              ...
              <Link
                href='https://www.linkedin.com/in/brian-caldera-724049244'
                className='text-gray-400 hover:text-primary-end transition-colors'
                target='_blank'
              ...
              <Link
                href='https://github.com/briancaldera'
                className='text-gray-400 hover:text-primary-end transition-colors'
                target='_blank'
          ...
          <div>
            ...
            <ul className='space-y-2'>
              <li>
                <Link
                  href='/#features'
                  className='text-gray-600 hover:text-primary-end transition-colors'
                >
                  Funcionalidades
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className='space-y-2'>
              ...
              <li>
                <Link
                  href='mailto:briancaldera07+support@gmail.com'
                  className='text-gray-600 hover:text-primary-end transition-colors'
                >
                  Contacto
                </Link>
        ...
        <div className='mt-12 pt-8 border-t border-gray-100 text-center text-gray-500 text-sm'>
          ...
          <p className='pt-4'>
            <span className='font-black text-primary-start'>&lt;&gt;</span> con{' '}
            <a
              href='https://youtu.be/UyQm4O9G7OM?feature=shared'
              target='_blank'
            >
              ❤️
            </a>{' '}
            ...
            <a
              href='https://briancaldera.com/'
              className='text-primary-end font-bold'
            >
              Brian Caldera
            </a>
          </p>
